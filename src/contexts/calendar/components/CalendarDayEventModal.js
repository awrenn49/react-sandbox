...
class CalendarDayEventModal extends Component {
  ...
  render() {
    ...
    this.props.eventInfo.start ? defaultStartDate = moment(this.props.eventInfo.start).hours(0).minutes(0) : defaultStartDate = null;
...
export default reduxForm({
  ...
  validate
    ...
    connect(mapStateToProps, { createEvent })(CalendarDayEventModal)
);
